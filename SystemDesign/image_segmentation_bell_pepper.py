...
def draw_results(image, segmentation_results, classification_results):
    ...
    # Check if masks are present in segmentation_results
    if segmentation_results[0].masks is not None:
        for mask in segmentation_results[0].masks.data.cpu().numpy():
        ...
        print("No detections found. Please try another image.")
...
if __name__ == "__main__":
    ...
    # Segment objects in the image, focusing on Bell pepper (class 0)
